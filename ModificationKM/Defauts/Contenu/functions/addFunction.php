		...
		<form method="POST" id="formulaire" enctype="multipart/form-data" action="Defauts\Contenu\mailBox\sendMail.php"> 
			<table id="tablefunction" class="table">
				...
				<tr>
					...
					<td><textarea onkeydown="insertTab(this, event);" class="form-control" id="description" name="description" required ></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><textarea onkeydown="insertTab(this, event);" class="form-control" id="explication0" name="explication0" required ></textarea></td>
				</tr>
				<tr>
					<td class="tdModifFunction">Exemple n° 0 : </td>
					<td><textarea onkeydown="insertTab(this, event);" class="form-control" id="exemple0" name="exemple0" ></textarea></td>
				</tr>
			</table>
